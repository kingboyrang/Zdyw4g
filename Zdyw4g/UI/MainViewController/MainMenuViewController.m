        ...
        if (_mainMenuShowType == MainMenuShowType_CallList) {
            if ((_startPoint.x - touchPoint.x>80)) {
                [UIView animateWithDuration:0.35 animations:^{
                    ...
                    [_callListBtn setTitleColor:[UIColor colorWithRed:118.0/255 green:118.0/255 blue:118.0/255 alpha:1.0] forState:UIControlStateNormal];
            ...
            if (touchPoint.x - _startPoint.x>80) {
                [UIView animateWithDuration:0.35 animations:^{
                    ...
                    _mainMenuShowType = MainMenuShowType_CallList;
                    _cursorImageView.center =CGPointMake( _callListBtn.center.x, CursorImageViewY);
                    [_contactListBtn setTitleColor:[UIColor colorWithRed:118.0/255 green:118.0/255 blue:118.0/255 alpha:1.0] forState:UIControlStateNormal];
                    [_callListBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
